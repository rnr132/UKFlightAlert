...
2. **`scripts/storage.py`** — written against confirmed shapes, not guesses. Daily-delta writer, compaction into monthly Parquet, retention rollup (min/p05/p25/p50/count, not mean).
